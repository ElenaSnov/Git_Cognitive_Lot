...
{
    var someField = $(".documentView-field-value[data-name='Поле 1']");	// поле
    var flag = $(".documentView-field-value[data-name='Поле 2']").find("input[type='checkbox']");	// чекбокс
    ...
    {
		hideViewElementColumn(someField);
    }
}
